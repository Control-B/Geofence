...
export function calculateDistanceMeters(fromLatitude: number, fromLongitude: number, toLatitude: number, toLongitude: number) {
...
export function getGeofenceStatus(distanceMeters: number, radiusMeters: number) {
